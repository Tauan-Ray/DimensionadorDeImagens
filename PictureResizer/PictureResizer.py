...
add_button = Button(app, text='+Novo' ,width=43, height=1, padx=3 ,anchor='center', font=('Arial 12'), relief='raised', overrelief='sunken', borderwidth=2, bg=Colorsendimg, fg=Colorfont)
add_button.place(x=0, y=35)

# Mostrado tamanho original e solicitando novos valores
originSize = Label(app, text=f'Altura e largura originais ', width=38, height=1, anchor='center', padx=8 ,font=('Courier 13 bold'), relief='flat', bg=Colorbackground, fg=Colorfont)
...
convert_button = Button(app, text='Converter' ,width=15, height=1 ,anchor='center', font=('Arial 10'), relief='raised', overrelief='sunken', borderwidth=2, bg=Colorconvert, fg=Colorfont)
